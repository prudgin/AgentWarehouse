...
<!-- PLACEHOLDER — list skills authored in this project (real files, not symlinks).
     Most library projects rely on warehouse skills and have few or no project-local
     ones; leave this section empty until a project-specific workflow emerges.
