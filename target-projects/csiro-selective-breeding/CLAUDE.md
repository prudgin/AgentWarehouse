# CLAUDE.md — 2022 CSIRO Selective Breeding
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2022 CSIRO Selective Breeding/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Development of a Murray cod selective breeding program. Multi-year project (Jul 2020–Sep 2025) in partnership with CSIRO, supporting the genetic improvement of MCA's broodstock. Initial genetic parameters and Estimated Breeding Values (EBVs) were run in March 2025; Phase II Development update was given May 2024. R&D project code: MCA004.

**WHY**: Selective breeding compounds: each generation of measured, ranked, and selected broodstock improves growth, FCR, and disease resistance. Establishing program infrastructure (pedigree, EBV pipeline) early is what makes the long-run gains accessible.

**HOW**:
- Project description: `Proposal/MCA - FY24 - Project Description - Selective Breeding.docx`.
- Phase II update: `Reports/2024-05 Development of a Murray cod selective breeding program - phase II update.pptx`.
- Initial genetic params / EBV run: `Reports/2025-03 MCA Initial genetic params and EBV run.pptx`.
- Background correspondence: `Articles/FW_ MCA Breeding program.msg`.
- This project has no on-site trial data — all R&D happens at CSIRO with periodic update presentations back to MCA.
