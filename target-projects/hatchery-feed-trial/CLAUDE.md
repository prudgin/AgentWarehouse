# CLAUDE.md — 2025 Hatchery Feed Trial
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2025 Hatchery Feed Trial/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Side-by-side comparison of two commercial hatchery feed brands — Inve vs Otohime — from weaning through to use of 1 mm extruded diets in early-stage Murray cod rearing. Five iterative proposal drafts (Sep–Nov 2025); the finalised proposal is `Proposal/Draft proposal - MCA Inve vs Otohime feed trial proposal Finalised 11.11.25.docx`. PI: Dr Trent D'Antignana (Nutrisea). Summary report drafted Feb 2026; PDF version 19 Mar 2026.

**WHY**: Hatchery feed brand affects early-stage survival, growth, and gut development — and the per-tonne cost. The trial picks a default brand for MCA's hatchery flow.

**HOW**:
- Proposal versions (most recent last): `Proposal/Draft proposal - MCA Inve vs Otohime feed trial proposal Finalised 11.11.25.docx`.
- Inve product literature: `Articles/010225_INVE Fish Hatchery and Nursery Diets_with Health_TOP Primo.pdf`.
- Otohime competitor literature: `Articles/O.range Minipellets__Oceania.pdf`.
- Vendor correspondence: `Articles/RE_ Artemia enrichment_.msg`.
- Recorded data: `Data/Data/`, `Data/spreadsheets/`.
- Reports: `Reports/MCA_Summary INVE vs Otohime Report_v10.02.26.docx` (Feb 2026 draft), `Reports/MCA_Summary INVE vs Otohime Report_v19.3.26.pdf` (March 2026 finalised), plus `Reports/Short summary of final report.docx`.
