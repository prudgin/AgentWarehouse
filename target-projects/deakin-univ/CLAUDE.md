...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2022 Deakin Univ/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Multi-component collaboration with Deakin University covering: (a) the Deakin feed trial (Trial 22-001) testing nutrient compositions and gut-health indicators in Murray cod, (b) FRDC-funded modelling of nutrient composition / growth / FCR cost ("DATA TRAIL PLUS SGR-FCR Cod Cost.pptx"), and (c) an exploratory feed-reallocation analysis between MCA and Aquna stocks.

**WHY**: External lab capacity at Deakin (especially around proximal composition and gut histology) closes gaps that MCA can't measure in-house. The collaboration also unlocks FRDC co-funding for the nutrient-composition strand.

**HOW**:
- Funding application: `Proposal/FRDC Funding Application 22-06-21 V2.docx`.
- NDA with Deakin: `Proposal/RMC18221 NDA between Murray Cod Australia and Deakin University - Fully signed.PDF`.
- Trial organisation: `Proposal/Trial 22-001 Organisation V1.doc`.
- Trial protocol + scoring forms: `Proposal/trial protocol/`, `Proposal/GUT Health Visual Scoring form and criteria MCA.docx`.
- Raw recording data spread across `Data/Data from DF/`, `Data/Deakin_DS data/`, `Data/Deakin feed trial/`, `Data/complete raw data/`, `Data/FRDC/`, plus FRDC fish xlsx files at the top of `Data/`.
- Nutrient composition deliverable: `Reports/Nutrient composition of Murray cod diets - Summary.docx`.
- FRDC modelling deck: `Expenses/DATA TRAIL PLUS SGR-FCR Cod Cost.pptx`.
