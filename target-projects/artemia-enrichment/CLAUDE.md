# CLAUDE.md — 2025 Artemia Enrichment
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2025 Artemia Enrichment/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Investigation of Artemia (brine shrimp) enrichment protocols for the hatchery — using Selco S.presso and Primo Selco S.presso to load lipid and HUFA content into newly-hatched Artemia before they are fed to Murray cod larvae. Includes pilot tank-allocation work (rows A–D dedicated to enrichment-fed trays), draft SOP, and pre-trial recipe notes.

**WHY**: Wild-grade Artemia lacks the lipid/HUFA profile larvae need. Enrichment fills that nutritional gap before live-feed-to-dry-feed weaning. Standardising the enrichment recipe is what makes hatchery batches comparable across runs.

**HOW**:
- Iterative proposal drafts (5 versions across Oct–Nov 2025): under `Proposal/Draft proposal - MCA Artemia enrichment proposal*.docx`. The latest finalised is `4.11.25`.
- Draft SOP: `Proposal/Artemia enrichment draft SOP.docx`, plus prior-iteration `Proposal/Enrichment notes and draft starting SOP 6_5_25.docx`.
- First-batch field notes (started 21-10-2025): `Proposal/Notes 21-10-2025.docx`.
- Pre-trial recipe handover: `Proposal/pre-trial artemia enrichment sw - Corey.docx`.
- Vendor instructions: `Articles/2017_PTA_Otohime_Brochure_1.pdf`, `Articles/Selco S.Presso instructions.pdf`.
- Vendor correspondence: `Articles/FW_ Selco S_presso.msg`, `Articles/RE_ Primo Selco S_Presso.msg`, `Articles/Artemia sample send.eml`.
- Spreadsheets tracking enrichment trays: `Data/spreadsheets/`.
