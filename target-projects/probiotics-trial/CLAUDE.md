# CLAUDE.md — 2024 Probiotics Trial
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2024 Probiotics Trial/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Pond-treatment trial comparing two commercial probiotic products — Epizym PST (control regime, 250 g weekly per pond) vs Pro-W (treatment regime, 324 g weekly per pond) — with a third-arm trial of EcoShock in one pond. The probiotics target accelerated waste degradation at the pond bottom. Includes sulphide testing (mixed vs unmixed bottle assay) as a secondary outcome.

**WHY**: Pond-bottom waste accumulation depresses water quality and forces water exchange. If probiotics speed degradation cheaply (Pro-W ≈ $1/day/pond), they could replace partial exchanges — a measurable operational saving.

**HOW**:
- Treatment protocols (per site): `Proposal/Bilbul probiotic trial.docx`, `Proposal/McFarlane's probiotic trial.docx`, `Proposal/Whitton probiotic trial.docx`.
- Approved proposal: `Proposal/Final Draft - MCA proposal_ probiotics 8_4_24.docx` (8 Apr 2024 final).
- Treatment data: `Data/epizym trial/`, `Data/sulphide testing/`, plus `Data/sulphide testing unmixed vs mixed.xlsx`.
- Epizym product literature: `Articles/epizym-pst3.pdf`.
- Interim report: `Reports/MCA_Interim Report_Pond Treatment Trial (18.09.24).pdf`.
- Final report: `Reports/MCA_Final Report_Pond Treatment Trial (25.06.25 V1).pdf` and a GPT-rewritten variant `Reports/Final report GPT rewrite.docx`.
