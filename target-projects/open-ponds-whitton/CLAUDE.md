# CLAUDE.md — 2023 Open Ponds Whitton
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2023 Open Ponds Whitton/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: Open-pond ("free range") production trial at Whitton, evaluating Murray cod growth in open-pond cages versus the standard in-pond cage configuration. Includes harvest movement records (fish moved into open ponds Jan 2024), redox/water-quality monitoring across the trial period (Nov 2023 – Dec 2024), and an experimental-design phase that ran through early 2024.

**WHY**: Open-pond husbandry has lower equipment cost than in-pond cages and may give better growth via larger swim volume — but it changes water-quality dynamics (sediment redox in particular). The trial decides whether free-range production is viable for MCA's farm conditions.

**HOW**:
- Trial-design proposals (multiple drafts): `Proposal/Draft proposal - MCA Open Pond Production  Trial  29_2_24.docx`, `Proposal/Final Draft MCA Open Pond Production proposal 8_4_24.docx`, `Proposal/Draft Open Pond Experimental Design Details 4_10_23.docx`.
- Design + sampling protocol: `Proposal/trial design - data collection.docx`, `Proposal/key dates.docx`.
- Free-range cage selection sheets: `Data/Copy of Potential cages for free range - WD.xlsx`, `Data/Deepika Pond stocking cages for free range.xlsx`, `Data/Potential cages for free range - deepika mercatus wts.xlsx`.
- Redox monitoring: `Data/Redox data for Whitton free range trial 13_11_23.xlsx`, `Data/Redox data for Whitton free range trial 3_12_24.xlsx`.
- Movement record: `Data/fish moved to open ponds as of 23.1.24.xlsx`.
- Design data: `Data/DS_OP trial design_18_12 - LM edit.xlsx`, `Data/Open ponds_DS data/`.
- Reports: `Reports/Average Weights for Movement 21.12.23.xlsx`, `Reports/Free Range Pond Estimated Harvest_.xlsx`, plus the formal reports under `Reports/reports/`.
