# CLAUDE.md — 2023 Stocking Density
...
This project is bidirectionally mirrored to `sharepoint_planning:PROJECTS/2023 Stocking Density/`. The local directory and the SharePoint folder hold **the same shape**, with one exception: code does not push.
...
**WHAT**: In-pond rectangular-cage stocking-density trial: how does varying density at stocking affect production efficiency and Murray cod performance? Final report (March 2024) authored by Dr Erin Bubner and Dr Trent D'Antignana. Companion to the round-vs-rectangular cage-design trial — uses rectangular cages and varies a single factor (density) within that cage shape.

**WHY**: Density is the cheapest production lever to adjust (no capex) but high density costs growth and survival. The trial quantifies the optimum.

**HOW**:
- Final report: `Reports/MCA_Final Stocking Density Report_FY23_24 (27_3_24)(2).pdf`. This is the canonical deliverable — the proposal/protocol live inside it.
- Recorded data: `Data/Stocking density_DS data/`.
- Communication: `Articles/FW_ Stocking density report .msg`.
